 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Nick Liu");
		  toPrint += p1.toString("nliu41");
		  
                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Haris Aslam");
		  toPrint += p2.toString("haslam3");
		  
                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Bowen Gui");
		  toPrint += p3.toString("bgui7");
                  
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Dylan Floyd");
                  toPrint += p4.toString("dfloyd7");
                  
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Son Nguyen");
                  toPrint += p5.toString("snguyen48");
